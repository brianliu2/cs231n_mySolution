...
#		self.optim_config[nn_para] = dict_nn_para_opt_config
...
if __name__ == '__main__':
	...
	plt.subplot(2, 1, 2)
	plt.title('Error')
	plt.plot(1-np.array(solver.train_acc_history), '-o', label='train')
	plt.plot(1-np.array(solver.val_acc_history), '-o', label='val')
